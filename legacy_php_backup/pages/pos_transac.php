                ...
                for($i=1; $i<=$countID; $i++)
                  {
                    ...
                    $db->query($query111)or die (print_r($db->errorInfo(), true));
...
<?php
              ...
              //       $db->query($query)or die ('Error in Database '.$query);
              ...
              //       $db->query($query2)or die ('Error in updating Database2 '.$query2);
              //   break;
              // }

              // $db->query("INSERT INTO transaction_details
              //                 (`ID`, `PRODUCTS`, `EMPLOYEE`, `ROLE`)
