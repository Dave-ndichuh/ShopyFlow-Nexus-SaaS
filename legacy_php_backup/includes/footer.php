...
$result = $db->query($sql) or die ("Bad SQL: $sql");
...
$opt .= "</select>";
        ...
        $query = "SELECT ID, e.FIRST_NAME, e.LAST_NAME, e.GENDER, USERNAME, PASSWORD, e.EMAIL, PHONE_NUMBER, j.JOB_TITLE, t.TYPE, l.PROVINCE, l.CITY
                      FROM users u
